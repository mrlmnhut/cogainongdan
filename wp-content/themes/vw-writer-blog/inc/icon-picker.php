...
class VW_Writer_Blog_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vw_writer_blog_font_awesome_icon_array = vw_writer_blog_font_awesome_icon_array();
                    foreach ($vw_writer_blog_font_awesome_icon_array as $vw_writer_blog_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_writer_blog_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_writer_blog_font_awesome_icon).'"></i>
                            <span class="vw-writer-blog-social-class">'.esc_attr($vw_writer_blog_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vw_writer_blog_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-writer-blog-customizer-script', get_template_directory_uri().'/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_writer_blog_customizer_script' );

if(!function_exists('vw_writer_blog_font_awesome_icon_array')){
    function vw_writer_blog_font_awesome_icon_array(){
