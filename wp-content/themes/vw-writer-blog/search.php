    ...
    <main id="maincontent" role="main" class="middle-align">
        <?php
            ...
            if($theme_lay == 'Left Sidebar'){ ?>
                <div class="row">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        ...
                        printf( esc_html__( 'Results For: %s','vw-writer-blog'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
                        ...
                        <div class="navigation">
                            <?php
                                ...
                                the_posts_pagination( array(
                                    'prev_text'          => __( 'Previous page', 'vw-writer-blog' ),
                                    'next_text'          => __( 'Next page', 'vw-writer-blog' ),
                                    'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-writer-blog' ) . ' </span>',
                                ) );
                            ?>
            ...
            <?php }else if($theme_lay == 'Grid Layout'){ ?>
                <div class="row">
                    <div id="our-services" class="services col-lg-9 col-lg-9">
                        <h1 class="entry-title"><?php /* translators: %s: search term */
                        printf( esc_html__( 'Results For: %s','vw-writer-blog'), esc_html( get_search_query() ) ); ?></h1> 
                        <div class="row">
                            <?php if ( have_posts() ) :
