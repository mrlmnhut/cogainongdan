	...
	public function widget($args, $instance){
		...
		<a class="mb-3 d-block" href="<?= get_permalink($the_posts[0]->ID) ?>">
            ...
            <div class="d-flex align-items-center">
                ...
                <span class="post-author"><?= get_the_author_meta( 'display_name', $the_posts[0]->post_author ) ?></span>
        ...
        <div class="d-flex flex-wrap">
            ...
            <a class="post-two-col mb-4" href="<?= get_permalink($the_posts[$item]->ID) ?>">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span class="post-author"><?= get_the_author_meta( 'display_name', $the_posts[$item]->post_author ) ?></span>
